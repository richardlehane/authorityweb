...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" version="1.0">
        ...
        <w:sectPr>
          ...
          <xsl:choose>
            <xsl:when test="$ORIENTATION='portrait'">
              ...
              <w:pgMar w:top="1418" w:right="1418" w:bottom="1418" w:left="1418" w:header="567"
                w:footer="567" w:gutter="0" />
            </xsl:when>
            <xsl:otherwise>
              <w:pgSz w:w="16840" w:h="11907" w:orient="landscape" w:code="9" />
              <w:pgMar w:top="1418" w:right="1134" w:bottom="1418" w:left="1134" w:header="567"
                w:footer="567" w:gutter="0" />
            </xsl:otherwise>
          </xsl:choose>
