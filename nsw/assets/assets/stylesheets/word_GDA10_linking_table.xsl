...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="LINKING_TABLE_HEADER"
                  select="'DRAFT - General Retention and Disposal Authority: Local Government records (Linking Table)'" />
    <xsl:template match="/">
        <xsl:processing-instruction name="mso-application">
            <xsl:text>progid="Word.Document"</xsl:text>
        </xsl:processing-instruction>
        <w:wordDocument w:macrosPresent="no"
                        w:embeddedObjPresent="no"
                        w:ocxPresent="no">
            <xsl:call-template name="word_header">
                <xsl:with-param name="tab"
                                select="'720'" />
                <xsl:with-param name="spacing"
                                select="'0'" />
            </xsl:call-template>
            ...
            <wx:sect>
                        ...
                        <w:tc>
                            ...
                            <w:p>
                                ...
                                <w:r>
                                    ...
                                    <w:t>
                                        <xsl:value-of select="$DEFAULT_PREFIX" />
                ...
                <w:sectPr>
                    <xsl:call-template name="portrait_header_footer">
                        <xsl:with-param name="header_first"
                                        select="$LINKING_TABLE_HEADER" />
                        <xsl:with-param name="tab"
                                        select="'9923'" />
                    </xsl:call-template>
                    <w:pgSz w:w="11906"
