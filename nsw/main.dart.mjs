...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1359: () => new FileReader(),
      _1361: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1362: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1362(f,arguments.length,x0) }),
      _1363: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1368: (x0,x1) => x0.removeChild(x1),
      _1369: x0 => x0.click(),
      _1370: x0 => new Blob(x0),
      _1371: x0 => globalThis.URL.revokeObjectURL(x0),
      _1376: Date.now,
      ...
      _1768: (x0,x1) => { x0.draggable = x1 },
      _1784: x0 => x0.style,
      _2141: (x0,x1) => { x0.target = x1 },
      _2143: (x0,x1) => { x0.download = x1 },
      _2168: (x0,x1) => { x0.href = x1 },
      _2713: (x0,x1) => { x0.accept = x1 },
      _2727: x0 => x0.files,
      _2753: (x0,x1) => { x0.multiple = x1 },
      _2771: (x0,x1) => { x0.type = x1 },
      _3490: () => globalThis.window,
      _6159: x0 => x0.firstChild,
      _6170: () => globalThis.document,
      _6590: (x0,x1) => { x0.id = x1 },
      _6617: x0 => x0.children,
      _8119: x0 => x0.size,
      _8120: x0 => x0.type,
      _8127: x0 => x0.name,
      _8133: x0 => x0.length,
